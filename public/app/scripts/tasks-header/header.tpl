<div id="selected-date-time" class="no-date"></div>
<div class="task-add-container animated paper-shadow paper-shadow-bottom-z-1" data-color="white">
  <div class="title-wrapper block">
    <div class="file-input-wrapper animated">
      ...
      <input type="file" accept="image/*" class="new-task-picture" tabindex="-1">
  ...
  <div class="controls-wrapper block">
    ...
    <core-toolbar class="toolbar">
      ...
      <span flex></span>
      <paper-button label="Save" class="button-primary button-add"></paper-button>
    </core-toolbar>
  </div>
